...
// --- Sub-component for Smoothly Cycling Text ---
    ...
    <div style={pageWrapper}>
      ...
      <style>{`
        * { font-family: 'Inter', -apple-system, sans-serif; box-sizing: border-box; }
        .scroll-area { flex: 1; width: 100%; overflow-y: auto; padding-bottom: 220px; padding-top: 100px; scrollbar-width: none; -ms-overflow-style: none; }
        ...
        .user-bubble { align-self: flex-end; background: linear-gradient(135deg, rgba(53, 114, 239, 0.12) 0%, rgba(53, 114, 239, 0.08) 100%); border: 1px solid rgba(53, 114, 239, 0.25); color: #fff; border-bottom-right-radius: 6px; }
        .ai-bubble { align-self: flex-start; background: rgba(255, 255, 255, 0.03); border: 1px solid rgba(255, 255, 255, 0.08); color: #a1a1a6; border-bottom-left-radius: 6px; backdrop-filter: blur(20px); width: 100%; max-width: 900px; }
