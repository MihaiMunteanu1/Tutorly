...
const TRANSLATIONS = {
  ro: {
    ...
    footer: "© 2026 AI Interface. Toate drepturile rezervate.",
    settings: "Setări",
    languageLabel: "Limbă"
  },
  en: {
    ...
    footer: "© 2026 AI Interface. All rights reserved.",
    settings: "Settings",
...
export default function IntroPage() {
  ...
  return (
    <div style={pageWrapper}>
      ...
      <style>{`
        /* Keep only page-specific animations (no background layers here) */
        @keyframes fadeInUp {
        ...
        .login-btn:hover { transform: translateY(-2px); box-shadow: 0 0 30px rgba(53, 114, 239, 0.45) !important; border-color: rgba(255,255,255,0.4) !important; }
      `}</style>
